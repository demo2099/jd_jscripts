...
0 8,21 1-8/1 3 * node /scripts/jd_firecrackers.js |ts >> /scripts/logs/jd_firecrackers.log 2>&1

#女装盲盒 活动时间：2021-2-26至2021-3-8
5 0,7,23 * * * node /scripts/jd_nzmh.js |ts >> /scripts/logs/jd_nzmh.log 2>&1
...
# 宠汪汪
55 */2,23 * * * node /scripts/jd_joy.js |ts >> /scripts/logs/jd_joy.log 2>&1
# 宠汪汪积分兑换京豆
...
#京喜财富岛
15 */2 * * * node /scripts/jd_cfd.js |ts >> /scripts/logs/jd_cfd.log 2>&1
...
# 必须要的默认定时任务请勿删除
55 18 * * * docker_entrypoint.sh |ts >> /scripts/logs/default_task.log 2>&1
